...
The term \emph{dependency} in this context does not exclusively refer to formally
...
An administrator might discover that an application that was working in one
